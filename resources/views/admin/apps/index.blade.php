				...
				<div class="card-body">
					...
					<div class="default-tab">
						<ul class="nav nav-tabs mb-3" role="tablist">
							<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#available">Available Addons</a>
							</li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#installed">Installed Addons</a>
							</li>
						</ul>
										...
										<div class="col-md-6 col-lg-3">
											<div class="card">
												...
												<div class="card-footer bg-white">
													...
													<span class="btn btn-sm btn-success float-end">{{$item->price}}</span>
												</div>
											</div>
										</div>
										@endforeach
