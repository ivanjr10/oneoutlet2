...
<div class="row">
			...
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media">
                     ...
                     <span>{{ trans('labels.restaurants') }}</span>
                  </div>
					...
					<div class="media">
						<div class="media-body white">
							<div class="row justify-content-space-evenly">
								<div class="media-body white">
                                @if($isMob == "1")
                                <a href="whatsapp://send/send?text={{URL::to('/')}}/{{Auth::user()->slug}}" target="_blank" class="btn btn-social btn-min-width btn-adn-flat mr-2 mb-2 btn-adn"><i class="fa-brands fa fa-whatsapp text-wa-color"></i> {{trans('labels.whatsapp')}}</a>
                                @else
                                <a href="https://web.whatsapp.com/send?text={{URL::to('/')}}/{{Auth::user()->slug}}" target="_blank" class="btn btn-social btn-min-width btn-adn-flat mr-2 mb-2 btn-adn"><i class="fa-brands fa fa-whatsapp text-wa-color"></i> {{trans('labels.whatsapp')}}</a>
                                @endif
								</div>
								<div class="media-body white">
	...
	<div class="col-sm-3">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">{{ trans('labels.restaurants') }}</h4>
			</div>
			<div class="card-body">
				<div class="card-block">
					<div class="chart-info mb-3 ml-3">
