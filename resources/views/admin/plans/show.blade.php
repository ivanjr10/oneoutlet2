	                    ...
	                    <form class="form form-horizontal form-bordered" action="{{URL::to('admin/plans/update-'.$pdata->id)}}" method="POST" enctype="multipart/form-data">
	                    	...
	                    	<div class="form-body">
	                    		...
	                    		<div class="row">
									...
									<div class="col-md-12">
				                        <div class="form-group row">
				                        	<label class="col-md-2 label-control" for="custom_domain">{{trans('labels.custom_domain')}}</label>
				                        	<div class="col-md-2">
												<input class="form-control" type="checkbox" name="custom_domain" id="custom_domain" @if ($pdata->custom_domain == '1') checked @endif>
				                            	@error('custom_domain')
