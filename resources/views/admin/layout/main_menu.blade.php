            ...
            <div class="nav-container">
               <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                  ...
                  <li class="{{ request()->is('admin/restaurants*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/restaurants')}}" class="menu-item"><i class="ft-align-justify"></i><span data-i18n="" class="menu-title">{{ trans('labels.restaurants') }}</span></a>
                  </li>
                  ...
                  <li class="{{ request()->is('admin/payments*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/payments')}}" class="menu-item"><i class="fa fa-credit-card"></i><span data-i18n="" class="menu-title">{{ trans('labels.payments') }}</span></a>
                  </li>
                  @endif
                  ...
                  @if (App\Models\SystemAddons::where('unique_identifier', 'custom_domain')->first() != null &&
                     ...
                     <li class="{{ request()->is('admin/custom_domain*') ? 'active' : '' }}">
                        <a href="{{ URL::to('/admin/custom_domain')}}" class="menu-item"><i class="fa fa-link"></i><span data-i18n="" class="menu-title">{{ trans('labels.custom_domains') }}</span></a>
                     </li>
                  @endif
                  ...
                  <li class="{{ request()->is('admin/language-settings*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/language-settings')}}" class="menu-item"><i class="fa fa-language"></i><span data-i18n="" class="menu-title">{{ trans('labels.language_settings') }}</span></span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">Add-on</span></a>
                  </li>
                  @endif
                  ...
                  <li class="{{ request()->is('admin/apps*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/admin/apps')}}" class="menu-item"><i class="fa fa-puzzle-piece"></i><span data-i18n="" class="menu-title">{{ trans('labels.apps') }}</span></a>
                  </li>
                  ...
                  @if (App\Models\SystemAddons::where('unique_identifier', 'custom_domain')->first() != null &&
                     ...
                     @php
                        if (Auth::user()->type == 2) {
                           $checkplan = App\Models\Transaction::where('restaurant', Auth::user()->id)
                              ->orderByDesc('id')
                              ->first();
                     ...
                     @endphp
                     @if ($custom_domain == 1)
                        <li class="{{ request()->is('vendor/custom_domain*') ? 'active' : '' }}">
                           <a href="{{ URL::to('/vendor/custom_domain')}}" class="menu-item"><i class="fa fa-link"></i><span data-i18n="" class="menu-title">{{ trans('labels.custom_domains') }}</span></a>
                        </li>
                     @endif
                  @endif
                  ...
                  <li class="{{ request()->is('vendor/payments*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/vendor/payments')}}" class="menu-item"><i class="fa fa-credit-card"></i><span data-i18n="" class="menu-title">{{ trans('labels.payments') }}</span></a>
                  </li>


                  @if (App\Models\SystemAddons::where('unique_identifier', 'coupons')->first() != null && App\Models\SystemAddons::where('unique_identifier', 'coupons')->first()->activated)
                  <li class="{{ request()->is('vendor/coupons*') ? 'active' : '' }}">
                     <a href="{{ URL::to('/vendor/coupons')}}" class="menu-item"><i class="ft-tag"></i><span data-i18n="" class="menu-title">{{ trans('labels.coupons') }}</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">Add-on</span></a>
                  </li>
                  @endif
