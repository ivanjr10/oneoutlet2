                                    ...
                                    <div class="pro-box">
                                        ...
                                        <div class="product-details-wrap">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <p class=" col-7 px-0 mb-0 {{ session()->get('direction') == '2' ? 'pl-2 pr-0 text-right' : '' }}">{{ Str::limit($item->description, 60) }}</p>

                                                <button class="btn btn-sm m-0 py-1 col-5 height-fit-content" onclick="GetProductOverview('{{$item->id}}')">{{trans('labels.add_to_cart')}}</button>
